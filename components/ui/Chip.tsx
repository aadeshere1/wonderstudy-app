...
export const Chip = ({
  ...
  const variantStyles = {
    default: active
      ...
      : "w-11 h-11 rounded-2xl border-2 border-white/10 bg-card2 text-white hover:border-mint hover:scale-110",
    pill: active
      ? "px-5 py-2 rounded-full bg-gradient-to-r from-gold to-orange-400 border-2 border-gold text-black"
      : "px-5 py-2 rounded-full border-2 border-white/10 bg-card2 text-white hover:border-purple",
  };
